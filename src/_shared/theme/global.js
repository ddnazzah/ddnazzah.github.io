...
html {
	...
	-webkit-tap-highlight-color: rgba(10, 25, 47, 0);
	margin: 0;
}
...
.n .navbar-light .navbar-toggler {
	color: rgba(10, 25, 47, 0.5);
	border-color: rgba(10, 25, 47, 0.1);
}

.navbar-light .navbar-toggler-icon {
	background-image: url("data:image/svg+xml,%3csvg viewBox='0 0 30 30' xmlns='http://www.w3.org/2000/svg'%3e%3cpath stroke='rgba(10, 25, 47, 0.5)' stroke-width='2' stroke-linecap='round' stroke-miterlimit='10' d='M4 7h22M4 15h22M4 23h22'/%3e%3c/svg%3e");
}
...
.card {
	...
	border: 1px solid rgba(10, 25, 47, 0.125);
	border-radius: 0.25rem;
}
.card > hr {
	margin-right: 0;
...
.card-header {
	...
	border-bottom: 1px solid rgba(10, 25, 47, 0.125);
}
...
.card-footer {
	padding: 0.75rem 1.25rem;
	background-color: rgba(10, 25, 47, 0.03);
	border-top: 1px solid rgba(10, 25, 47, 0.125);
}
...
.toast {
	...
	-webkit-box-shadow: 0 0.25rem 0.75rem rgba(10, 25, 47, 0.1);
	box-shadow: 0 0.25rem 0.75rem rgba(10, 25, 47, 0.1);
...
.bs-popover-auto[x-placement^='top'] > .arrow::before {
	...
	border-top-color: rgba(10, 25, 47, 0.25);
}
...
.bs-popover-auto[x-placement^='right'] > .arrow::before {
	...
	border-right-color: rgba(10, 25, 47, 0.25);
}
...
.bs-popover-auto[x-placement^='bottom'] > .arrow::before {
	...
	border-bottom-color: rgba(10, 25, 47, 0.25);
}
...
.bs-popover-auto[x-placement^='left'] > .arrow::before {
	...
	border-left-color: rgba(10, 25, 47, 0.25);
}
...
.shadow-sm {
	-webkit-box-shadow: 0 0.125rem 0.25rem rgba(10, 25, 47, 0.075) !important;
	box-shadow: 0 0.125rem 0.25rem rgba(10, 25, 47, 0.075) !important;
}

.shadow {
	-webkit-box-shadow: 0 0.5rem 1rem rgba(10, 25, 47, 0.15) !important;
	box-shadow: 0 0.5rem 1rem rgba(10, 25, 47, 0.15) !important;
}

.shadow-lg {
	-webkit-box-shadow: 0 1rem 3rem rgba(10, 25, 47, 0.175) !important;
	box-shadow: 0 1rem 3rem rgba(10, 25, 47, 0.175) !important;
}
...
.ddnazzah-navbar-light .container {
	width: 1110px;
	margin: 0 auto;
	padding: 0;
}
.ddnazzah-navbar-light .navbar-brand {
	color: #fff;
	padding-top: 0.7rem;
	padding-bottom: 0.7rem;
}
.ddnazzah-navbar-light .navbar-brand:hover,
.ddnazzah-navbar-light .navbar-brand:focus {
	color: #fff !important;
}
@media (max-width: 991.98px) {
	.ddnazzah-navbar-light .navbar-brand {
...
@media (max-width: 991.98px) {
	.ddnazzah-navbar-light .navbar-nav {
		padding-bottom: 20px;
		margin-right: 0;
	}
}
.ddnazzah-navbar-light .navbar-nav > .nav-item > .nav-link {
	font-size: 16px;
	padding-top: 0.7rem;
	padding-bottom: 0.7rem;
	padding-left: 20px;
...
.ddnazzah-navbar-light .navbar-nav > .nav-item > .nav-link span {
	position: relative;
	display: block;
	padding-bottom: 2px;
}
...
.ddnazzah-navbar-light .navbar-nav > .nav-item > .nav-link span:before {
	content: '';
	position: absolute;
	width: 100%;
	height: 2px;
...
.ddnazzah-navbar-light .navbar-nav > .nav-item > .nav-link:hover span:before {
	visibility: visible;
...
.ddnazzah-navbar-light .navbar-nav > .nav-item.cta > a span {
	display: inline-block;
	color: #fff;
}
...
.ddnazzah-navbar-light.scrolled .nav-item.cta > a span {
	display: inline-block;
	color: #fff !important;
}
...
.ddnazzah-navbar-light.scrolled .navbar-toggler {
	border: none;
	color: rgba(255, 255, 255, 0.5) !important;
...
.ddnazzah-navbar-light.scrolled.sleep {
	-webkit-transition: 0.3s all ease-out;
	-o-transition: 0.3s all ease-out;
	transition: 0.3s all ease-out;
}
.ddnazzah-navbar-light.scrolled .navbar-brand {
	color: #fff;
	padding-top: 1rem;
	padding-bottom: 1rem;
	font-size: 24px;
...
.btn {
	cursor: pointer;
	-webkit-box-shadow: 0px 24px 36px -11px rgba(10, 25, 47, 0.09);
	-moz-box-shadow: 0px 24px 36px -11px rgba(10, 25, 47, 0.09);
	box-shadow: 0px 24px 36px -11px rgba(10, 25, 47, 0.09);
	font-size: 12px;
	text-transform: uppercase;
	letter-spacing: 2px;
	font-weight: 600;
...
.ddnazzah-about .img-about {
	width: 100%;
	z-index: 0;
	position: relative;
}
.ddnazzah-about .img-about .img {
	display: block;
	width: 100%;
	position: relative;
	z-index: 1;
...
.ddnazzah-about ul.about-info {
	display: inline-block;
	padding: 0;
	margin: 0;
	width: 100%;
}
.ddnazzah-about ul.about-info li {
	list-style: none;
	margin-bottom: 10px;
}
.ddnazzah-about ul.about-info li span {
	width: calc(100% - 130px);
}
.ddnazzah-about ul.about-info li span:first-child {
	font-weight: 600;
	color: #fff;
	width: 130px;
}

.ddnazzah-about .counter-wrap .text p {
	font-size: 20px;
}
.ddnazzah-about .counter-wrap .text p span {
	font-weight: 400;
	color: #fff;
}
...
.services-1 {
	...
	-moz-box-shadow: 0px 20px 69px -27px rgba(10, 25, 47, 0.17);
	box-shadow: 0px 20px 69px -27px rgba(10, 25, 47, 0.17);
}
.services-1 .icon {
	display: block;
	margin-bottom: 30px;
...
.project:focus .overlay {
	box-shadow: 0 0 10px 0 rgba(100, 255, 218, 0.4);
	opacity: 0.9;
}
.project:hover .text,
.project:focus .text {
...
.ddnazzah-footer .ddnazzah-footer-logo {
	text-transform: uppercase;
	letter-spacing: 0.1em;
}
.ddnazzah-footer .ddnazzah-footer-widget h2 {
	font-weight: normal;
	color: #fff;
	margin-bottom: 40px;
	font-size: 22px;
...
.ddnazzah-footer .ddnazzah-footer-widget ul li {
	margin-bottom: 10px;
}
.ddnazzah-footer .ddnazzah-footer-widget ul li a {
	color: rgba(255, 255, 255, 0.6);
}
.ddnazzah-footer .ddnazzah-footer-widget ul li a span {
	color: rgba(255, 255, 255, 0.6);
}
.ddnazzah-footer .ddnazzah-footer-widget .btn-primary {
	background: #fff !important;
	border: 2px solid #fff !important;
}
.ddnazzah-footer .ddnazzah-footer-widget .btn-primary:hover {
	background: #fff;
	border: 2px solid #fff !important;
}
.ddnazzah-footer p {
...
.ddnazzah-footer-social ul::after {
	content: '';
	display: block;
	width: 1px;
	height: 90px;
...
.ddnazzah-footer-social li {
	display: list-item;
	text-align: -webkit-match-parent;
}

.ddnazzah-footer-social li a {
	font-size: large;
	position: relative;
	margin-bottom: 1rem !important;
	display: block;
...
.ddnazzah-footer-social li a:focus {
	transform: translateY(-3px) !important;
}

.ddnazzah-footer-social2 {
	color: rgb(168, 178, 209);
}

.ddnazzah-footer-social2 ul {
	display: flex;
	flex-direction: row;
	-webkit-box-align: center;
	justify-content: center;
...
.ddnazzah-footer-social2 li {
	display: list-item;
	text-align: -webkit-match-parent;
}

.ddnazzah-footer-social2 li a {
	font-size: large;
	position: relative;
	margin-right: 1rem !important;
	display: block;
...
.ddnazzah-footer-social2 li a span {
	font-size: 20px;
}

.ddnazzah-footer-social2 li a:hover,
.ddnazzah-footer-social2 li a:focus {
	transform: translateY(-3px) !important;
}

.ddnazzah-footer-email {
	width: 40px;
	position: fixed;
	bottom: 0px;
	left: auto;
...
.ddnazzah-footer-email .ddnazzah-footer-email-inner {
	display: flex;
	flex-direction: column;
	-webkit-box-align: center;
	align-items: center;
...
.ddnazzah-footer-email .ddnazzah-footer-email-inner a {
	font-family: 'SF Mono', 'Fira Code', 'Fira Mono', 'Roboto Mono', 'Lucida Console', Monaco, monospace;
	font-size: 12px;
	letter-spacing: 0.1em;
...
.ddnazzah-footer-email .ddnazzah-footer-email-inner a:after {
	content: '';
	display: inline-flex;
	width: 1px;
	height: 90px;
...
.ddnazzah-footer-email .ddnazzah-footer-email-inner a:hover,
.ddnazzah-footer-email .ddnazzah-footer-email-inner a:focus {
	transform: translateY(-3px) !important;
}
...
.ddnazzah-counter .block-18 {
	...
	-ms-border-radius: 5px;
	border-radius: 5px;
	border: 0.5px solid rgba(100, 255, 218, 0.1);
}
...
@media (max-width: 767.98px) {
	.ddnazzah-counter .counter-wrap {
		margin-bottom: 20px;
	}
}

.ddnazzah-counter .ddnazzah-number {
	display: block;
	font-size: 72px;
	font-weight: bold;
	color: ${({ theme }) => theme.textPrimary};
